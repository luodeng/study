 ...
 */
public class SingletonFiveToStaticInnerClass {
    private static class SingletonHolder {  
    private static final SingletonFiveToStaticInnerClass INSTANCE = new SingletonFiveToStaticInnerClass();
    }  
    private SingletonFiveToStaticInnerClass(){}
    public static final SingletonFiveToStaticInnerClass getInstance() {
