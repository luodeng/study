...
public class UploadUtil {
	...
	public void uploadFile(final File file, final String fileKey,
		...
		log.info(TAG, "请求的URL=" + RequestURL);
		log.info(TAG, "请求的fileName=" + file.getName());
		log.info(TAG, "请求的fileKey=" + fileKey);
...
//					dos.flush();
			...
			log.info(TAG, file.getName()+"=" + params+"##");
			dos.write(params.getBytes());
			/**上传文件*/
...
//			dos.write(tempOutputStream.toByteArray());
			...
			log.error(TAG, "response code:" + res);
			if (res == 200) {
				log.error(TAG, "request success");
