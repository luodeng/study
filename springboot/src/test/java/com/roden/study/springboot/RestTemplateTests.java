package com.roden.study.springboot;

import com.roden.study.springboot.dto.Product;
 ...
 * https://github.com/wrcj12138aaa/resttemplate
 *
 */
public class RestTemplateTests {
    ...
    public void testUploadFile() {
        ...
        Object file = new FileSystemResource(new File("RestTemplateTests.class"));
        body.add("file", file);
