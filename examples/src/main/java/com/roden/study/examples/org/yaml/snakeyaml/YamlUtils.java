 ...
 * https://blog.csdn.net/hexiaodiao/article/details/86695664
 */
public class YamlUtils {
    ...
    public static void main(String[] args) throws Exception {
        //File yml = new File(Objects.requireNonNull(YamlUtils.class.getClassLoader().getResource("config.yml")).toURI());
        File yml = new File("D:\\project\\hyj\\hyj-admin\\src\\main\\resources\\application.yml");
        YamlUtils.setYmlFile(yml);
        System.out.println(YamlUtils.getByKey("spring.profiles.active"));
        YamlUtils.saveOrUpdateByKey("spring.profiles.active", "test");
